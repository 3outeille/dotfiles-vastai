...
Possible breakign change remotePath is not longs translated when using wsl or cygwim
...
cygpath option and fix issue [#33](https://github.com/thisboyiscrazy/vscode-rsync/issues/33)
