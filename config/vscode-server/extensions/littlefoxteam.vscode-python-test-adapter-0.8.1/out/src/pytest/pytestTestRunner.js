...
class PytestTestRunner {
    ...
    load(config) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const tests = (0, pytestTestCollectionParser_1.parseTestSuites)(result.output, config.getCwd());
    ...
    run(config, test, outputCollector) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const states = yield (0, pytestJunitTestStatesParser_1.parseTestStates)(file, config.getCwd());
            cleanupCallback();
            return states;
        });
    }
    runPytest(config, env, args, outputCollector) {
        ...
        if (pytestPath === path.basename(pytestPath)) {
            ...
            return (0, pythonRunner_1.runModule)({
        ...
        return (0, processRunner_1.runProcess)(pytestPath, args, {
            cwd: config.getCwd(),
            environment: env,
            acceptedExitCodes: PYTEST_NON_ERROR_EXIT_CODES,
            outputCollector,
    ...
    loadEnvironmentVariables(config) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const updatedPytestPlugins = [envFileEnvironment.PYTEST_PLUGINS, DISCOVERY_OUTPUT_PLUGIN_INFO.MODULE_NAME]
                .filter((item) => item)
                .join(',');
            return Object.assign(Object.assign({}, envFileEnvironment), { PYTHONPATH: updatedPythonPath, PYTEST_PLUGINS: updatedPytestPlugins });
        });
    }
    ...
    getRunArguments(test, rawPytestArguments) {
        ...
        return {
            ...
            argumentsToPass: argumentsToPass.concat(test !== this.adapterId ? [test] : knownArguments.tests || []),
        };
    }
